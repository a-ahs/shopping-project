                          ...
                          <div class="card-body">
                              <div class="row">
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <label>قیمت</label>
                                          <input type="text" class="form-control" value="{{ $product->price }}" name="price" placeholder="قیمت را وارد کنید">
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-md-4">
                                      ...
                                      <img src="/{{ $product->thumbnail_url }}" alt="" width="100" height="100">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                      ...
                                      <img src="/{{ $product->demo_url }}" alt="" width="100" height="100">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <a href="{{ route('admin.products.download.source', $product->id) }}" class="btn btn-default btn-icons"><i class="fa fa-edit"></i>لینک دانلود سورس فایل</a>
                                  </div>
